# Generated by Django 3.1.6 on 2021-05-22 11:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bezel_material', models.ForeignKey(blank=True, default='1', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='bezel_material', to='prod.material', verbose_name='Материал безеля')),
                ('bracer', models.ForeignKey(blank=True, default='1', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='bracer', to='prod.material', verbose_name='Материал браслета')),
                ('bracer_colour', models.ForeignKey(blank=True, default='1', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='bracer_colour', to='prod.colour', verbose_name='Цвет браслета')),
                ('brand', models.ForeignKey(blank=True, default='1', null=True, on_delete=django.db.models.deletion.CASCADE, to='prod.brand', verbose_name='Бренд')),
                ('condition', models.ForeignKey(blank=True, default='1', null=True, on_delete=django.db.models.deletion.CASCADE, to='prod.condition', verbose_name='Состояние часов')),
                ('corpus_material', models.ForeignKey(blank=True, default='1', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='corpus_material', to='prod.material', verbose_name='Материал корпуса')),
                ('dial', models.ForeignKey(blank=True, default='1', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='dial_colour', to='prod.colour', verbose_name='Циферблат')),
                ('equipment', models.ForeignKey(blank=True, default='1', null=True, on_delete=django.db.models.deletion.CASCADE, to='prod.equipment', verbose_name='Комплектация')),
                ('glass', models.ForeignKey(blank=True, default='1', null=True, on_delete=django.db.models.deletion.CASCADE, to='prod.glass', verbose_name='Стекло')),
                ('meh_type', models.ForeignKey(blank=True, default='1', null=True, on_delete=django.db.models.deletion.CASCADE, to='prod.mehtype', verbose_name='Тип механизма')),
                ('numbers', models.ForeignKey(blank=True, default='1', null=True, on_delete=django.db.models.deletion.CASCADE, to='prod.numbers', verbose_name='Цифры')),
                ('sex', models.ForeignKey(blank=True, default='1', null=True, on_delete=django.db.models.deletion.CASCADE, to='prod.sex', verbose_name='Пол')),
            ],
            options={
                'verbose_name': 'Часы',
